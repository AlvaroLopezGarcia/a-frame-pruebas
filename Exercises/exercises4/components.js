...
AFRAME.registerComponent('mobile_component', {
  ...
  init: function(){
    ...
    this.eventMobileHandlerMouseDown = function (){
      ...
      let instructions = document.getElementById(program_id).children[3].children;
...
AFRAME.registerComponent('button', {
  ...
  init: function () {
    ...
    this.eventButtonHandlerUp = function (e) {
      e.stopPropagation();
      let box = document.createElement('a-box');
      ...
      let pos = programmer.children[4].getAttribute("position");
      let pos_x = pos.x + 2;
      let pos_y = pos.y;
      let incremento = 1;
    ...
    this.eventButtonHandlerDown = function (e) {
      e.stopPropagation();
      let box = document.createElement('a-box');
      document.getElementById("instructions").appendChild(box);
      let programmer = document.getElementById("programmer");
